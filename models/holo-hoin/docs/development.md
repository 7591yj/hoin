...
- `holo_hoin/`: importable package with training, export, evaluation, and shared model code.
...
- `class_map.json` and `config.json`: sidecar metadata copied from checkpoints when present.
